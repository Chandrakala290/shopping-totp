...
window.addEventListener("DOMContentLoaded", () => {
      ...
      if (sdk && typeof sdk.initialize === "function") {
        sdk
          ...
          .then((data) => {
            ...
            if (deviceInfo.riskScore) {
              window.setRiskScore(deviceInfo.riskScore);
            }
    ...
    fetch(apiUrl, {
      ...
      .then((response) => {
        ...
        if (response?.authType === "OTP") {
          ...
          const apiUrl = `https://fis-demo.appsteer.io/services/mfa/totp/getUrl?username=${cardName}`;
          console.log(apiUrl);
          fetch(apiUrl, {
            method: "GET",
            headers: {
              "Content-Type": "application/json",
              "x-api-key": "C3AB8FF13720E8AD9047DD39466B3C8974E592C2FA383D4A3960714CAEF0C4F2",
              "x-forwarded-host": "dev.appsteer.io",
            ...
            .then((data) => {
              if (data?.image) {
                ...
                qrImg.src = data.image; // ✅ direct assign
  ...
  window.validateCaptcha = function () {
    ...
    const apiurl = "https://fis-demo.appsteer.io/mfa/captcha/validate";
  ...
  window.validateAnswer = function () {
    showLoader();
    const apiurl =
      "https://frm-demo.appsteer.io/services/mobile/external/triggerAPI/e2fc9bea-b5c0-4780-aa58-d4f425b28b3b";
  ...
  window.submitOtp = function () {
    ...
    // }
    const cardName = document.getElementById("cardName").value.trim();
    const otpApiUrl = `https://fis-demo.appsteer.io/services/mfa/totp/validate?otp=${token}&username=${cardName}`;
    fetch(otpApiUrl, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
